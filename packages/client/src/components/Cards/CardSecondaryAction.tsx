    ...
    return (
        <Tooltip title={title || 'Reference'} placement="left">
            <ButtonBase disableRipple>
                {!icon && (
                    <Avatar component="a" href={link} target="_blank" alt="MUI Logo" size="badge" color="primary" outline>
                ...
                {icon && (
                    <Avatar component="a" href={link} target="_blank" size="badge" color="primary" outline>
                        {icon}
                    </Avatar>
                )}
            </ButtonBase>
